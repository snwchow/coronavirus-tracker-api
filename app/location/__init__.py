...
class TimelinedLocation(Location):
    ...
    """
    #This would be the Extended Abstraction
...
# pylint: disable=redefined-builtin,invalid-name
class LocationImplementor(metaclass=ABCMeta):  # pylint: disable=too-many-instance-attributes
    """
    A locationImplementor in the world affected by the coronavirus.
    """
    #This would be the Implementor
...
class TimelinedLocationImplementor(LocationImplementor):
    """
    A location implementor with timelines.
    """
    #This would be an "extended" implementor
