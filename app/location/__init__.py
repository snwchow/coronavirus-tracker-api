...
class LocationBuilderInterface(metaclass=ABCMeta):  # pylint: disable=too-many-instance-attributes
    """
    The Abstract Location Builder Interface
    """
    ...
    # def build_part_a():
    #     "Build part a, such as id"
    #
    # def build_part_b():
    #     "Build part b, such as state"
    # ...
    # def get_result():
    #     "Return final product"


class TimelinedLocationBuilderInterface(LocationBuilderInterface):
    """
    The Abstract Timelined Location Builder Interface
    """
